...
@section('content')
            ...
            <div class="SendUsMail">
               ...
               <form name="emailform" method="POST" action="{{ url('contactus') }}"  >
                  {{csrf_field()}}
                  <div class="row">
            ...
            <!--this section show ContactInfo  $ContactUsInfo {{ nl2br(e($text)) }} -->
            <div class="ContactInfo">
               <h2> Contact Information </h2>
            </div>
            nl2br(e({{$ContactUsInfo -> ContactUs_ContactInfo}}))
